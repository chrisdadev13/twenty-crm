            ...
            <List.Item.Detail
              metadata={
                <List.Item.Detail.Metadata>
                  ...
                  />
                  <List.Item.Detail.Metadata.Separator />
                  <List.Item.Detail.Metadata.Label title="Opportunities" />
                  {person.pointOfContactForOpportunities && person.pointOfContactForOpportunities.length ? (
                    person.pointOfContactForOpportunities.map((opportunity) => (
                      <>
                        <List.Item.Detail.Metadata.Label title="Name" text={opportunity.name ?? "Empty"} />
                        <List.Item.Detail.Metadata.Label title="Stage" text={opportunity.stage ?? "Empty"} />
                        <List.Item.Detail.Metadata.Label
                          title="Created at"
                          text={new Date(opportunity.createdAt).toLocaleString("en-US") ?? "Empty"}
                        />
                        <List.Item.Detail.Metadata.Separator />
                      </>
                    ))
                    ...
                    <List.Item.Detail.Metadata.Label
                      ...
                      text="This person has no associated opportunities"
                    />
                  )}
                </List.Item.Detail.Metadata>
              }
